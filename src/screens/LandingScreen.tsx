  ...
  >
    ...
    <div className="flex lg:hidden items-center gap-x-2">
      <Button
        onClick={() => onEnter('client')}
        variant="secondary"
        className="py-2 px-3 text-sm w-auto whitespace-nowrap"
      >
        Sou Cliente
      </Button>
      <button
        ...
        <div className="-my-6 divide-y divide-gray-500/25">
          <div className="space-y-2 py-6">
            <a
              href="#inicio"
              onClick={() => setMobileMenuOpen(false)}
              className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-brand-secondary"
            >
              Início
            </a>
            <a
