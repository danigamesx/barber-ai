                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <Button onClick={() => onEnter('barbershop')} variant="primary" className="py-3 px-8 text-base w-auto shadow-lg shadow-amber-500/20">
                ...
                <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {plans.map((plan) => (
                        <div key={plan.id} className={`rounded-3xl p-8 ring-1 xl:p-10 ${plan.mostPopular ? 'ring-2 ring-brand-primary bg-gray-800/50' : 'ring-gray-700'}`}>
                            ...
                            <Button onClick={() => onEnter('barbershop')} variant={plan.mostPopular ? 'primary' : 'secondary'} className="mt-6 w-full">Contratar Plano</Button>
