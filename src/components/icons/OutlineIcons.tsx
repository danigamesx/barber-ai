...
export const UsersIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962A3.75 3.75 0 019 12a3.75 3.75 0 015.026-3.75m-5.026 3.75a3.75 3.75 0 00-3.75-3.75M3 13.5a3.75 3.75 0 013.75-3.75m10.5 0a3.75 3.75 0 013.75 3.75m-3.75 0a3.75 3.75 0 00-3.75 3.75M9 12a3.75 3.75 0 013.75-3.75m0 3.75a3.75 3.75 0 01-3.75 3.75m0-3.75a3.75 3.75 0 00-3.75 3.75m6.75-3a3.75 3.75 0 00-3.75-3.75M9 15.75a3.75 3.75 0 013.75-3.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);
...
export const BarbershopIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 12.75l-3.364 3.364a2.25 2.25 0 000 3.182l.09.09a2.25 2.25 0 003.182 0l3.364-3.364m5.25-5.25l3.364-3.364a2.25 2.25 0 000-3.182l-.09-.09a2.25 2.25 0 00-3.182 0L12 7.5m-5.25 5.25l5.25-5.25m0 0l5.25 5.25m-5.25-5.25v5.25m0 0h5.25" />
  </svg>
);
...
export const MegaphoneIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.136 12.006a8.25 8.25 0 0113.728 0M1.984 8.974a12 12 0 0120.032 0M15.75 18a3.75 3.75 0 00-7.5 0" />
  </svg>
);
...
export const CalendarDaysIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18.75zM12 12.75h.008v.008H12v-.008zM12 15.75h.008v.008H12v-.008zM9 12.75h.008v.008H9v-.008zM9 15.75h.008v.008H9v-.008zM6 12.75h.008v.008H6v-.008zM6 15.75h.008v.008H6v-.008z" />
    </svg>
);

export const ChatBubbleBottomCenterTextIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.372A5.555 5.555 0 0111.375 16.5H12a.375.375 0 01.375.375V18a.375.375 0 01-.375.375h-.625A5.555 5.555 0 016 20.625a9.76 9.76 0 01-2.53-.372C1.03 19.366 0 16.666 0 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
    </svg>
);
...
export const ShareIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.044.588.05H11.25a2.25 2.25 0 012.25 2.25v.015c0 .324.22.61.533.692A2.25 2.25 0 1011.25 15m0-4.093c0 .195.019.386.052.574m0 0a2.25 2.25 0 102.196 2.196M11.25 11.25v2.505m0 0a2.25 2.25 0 100 4.5m0-4.5a2.25 2.25 0 110 4.5" />
  </svg>
);
